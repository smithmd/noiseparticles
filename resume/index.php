  ...
  <fieldset class="section">
    ...
    <div class="exp_section">
      ...
      <ul>
        ...
        <li>Administer Aspen Student Information System and write procedures, reports, imports in Java</li>
      </ul>
    </div>
    ...
    <div class="exp_section last">
      ...
      <ul>
        ...
        <li>Create e-mail templates.</li>
        <li>Write SQL scripts and stored procedures.</li>
      </ul>
    </div>
  </fieldset>
  <fieldset class="section">
